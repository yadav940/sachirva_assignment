...
class SachirvaRoutes {
  ...
  static void configureRoutes(Router router) {
    router.define(root,
        handler: SachirvaPreferences().getLoginStatus()?homeHandler:rootHandler, transitionType: TransitionType.inFromRight);
    ...
    router.define(lookTagging,
        handler: lookTaggingHandler, transitionType: TransitionType.inFromRight);
